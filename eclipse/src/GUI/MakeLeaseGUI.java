...
public class MakeLeaseGUI extends JFrame {
	...
	private JTextField nrOfDaysField;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MakeLeaseGUI frame = new MakeLeaseGUI();
	...
	public MakeLeaseGUI() {
		...
		JLabel lblNewSale = new JLabel("NEW LEASE");
		...
		JLabel lblNewLabel = new JLabel("NR. OF DAYS:");
		makeSalePanel.add(lblNewLabel, "cell 1 7");
		
		nrOfDaysField = new JTextField();
		makeSalePanel.add(nrOfDaysField, "cell 2 7,growx");
		nrOfDaysField.setColumns(10);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (idField.getText().equals("")
					...
					if (!orderCreated) {
						...
						int nrOfDays = Integer.parseInt(nrOfDaysField
								.getText());
						String name = nameField.getText();
						controller.makeLease(id, cname, ename);
						controller.addSubLeaseToLease(id, name, nrOfDays);
						...
						nameField.setText("");
						nrOfDaysField.setText("");
						orderCreated = true;

					} else {
						int amount = Integer.parseInt(nrOfDaysField
								.getText());
						String name = nameField.getText();
						controller.addSubLeaseToLease(id, name, amount);
						nameField.setText("");
						nrOfDaysField.setText("");
					}
		...
		btnPrintTotal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				controller.calculateTotalForLease(id);
				textPane.setText(controller.searchLease(id));
